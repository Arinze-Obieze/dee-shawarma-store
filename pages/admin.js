...
const Imageupload = () => {
    ...
    async function uploadData() {
        try {
            ...
            const response = await fetch(url, {
                ...
                body: JSON.stringify({
                    image: image, // Extract Base64 data from the image URL
                    text: text,
                    number: number,
                }),
            });
    ...
    return (
        <div className="mb-40">
            ...
            <div>
                {message && (
                    <div className="flex  w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 mx-auto mt-5">
                        ...
                        <div clasName="px-4 py-2 -mx-3">
                            <div clasName="mx-3">
                                <span clasName="font-semibold text-emerald-500 dark:text-emerald-400">Success</span>
                                <p clasName="text-sm text-gray-600 dark:text-gray-200">
                                    The data has been uploaded to the database
                                </p>
                            </div>
                        </div>
                    </div>
